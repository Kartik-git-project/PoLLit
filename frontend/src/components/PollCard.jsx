...
import { Avatar, inputCls } from "./UIElements.jsx";
    ...
    <div className={s.card}>
      ...
      <div className="p-4">
        ...
        <div className={s.footer}>
          <button
            onClick={handleTotalVoteClick}
            className={`${s.action} flex items-center gap-1 cursor-pointer transition-colors ${
              voted ? "text-emerald-400 font-medium" : ""
            }`}
          >
            <ArrowBigUp
              size={14}
              className={voted ? "fill-emerald-400 text-emerald-400" : ""}
            />
